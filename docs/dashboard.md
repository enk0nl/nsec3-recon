...
NSEC3 runs also write `nsec3_chain.tsv`, a tab-separated full-chain artifact containing walked NSEC3 hashes, next-hash links, NSEC3 parameters, RR types, and recovered plaintext/FQDN values where cracked.

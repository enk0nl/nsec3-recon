...
Bootstrap source dependencies default to pinned refs: nsec3map `5af04b9c900b8f0f1a2113a22f5b34e67e637c80`, scheduler `cde74dbbccc641161846a9ccabf81551c3d586c1`, PCFG `171f89e85206cb22e89c3803c13f6a320d538e8b`, SecLists `198047f1e22251e3b88b98b10e8bd15283e8a1e9`, OpenTaal `b250510dda431785f962019167d1415198ff3905`, and Dutch DNS wordlists `87403dff13f2a9da53084c88412a6e19280003ec`. Pipeline setup writes requested refs and resolved commits to `config/dependency_manifest.json`.

The current default scheduler ref is `cde74dbbccc641161846a9ccabf81551c3d586c1`, which includes the optimized-kernel failover API consumed by NSEC3 Recon. `SCHEDULER_REF=<custom-ref> scripts/bootstrap.sh` still overrides this default. The dependency manifest records the requested scheduler ref, resolved commit, and whether scheduler help advertises `--no-optimized-kernels`, `--optimized-kernel-failover`, and `--no-optimized-kernel-failover`.
